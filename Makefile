...
bin/punteros: obj/main.o obj/funciones.o obj/bytes.o	 
	gcc -fsanitize=address,undefined -I include/ obj/main.o obj/funciones.o obj/bytes.o pruebas.a -o punteros

obj/main.o: src/main.c
	gcc -c -Wall -I include/ src/main.c -g 

obj/bytes.o: src/bytes.c
	gcc -c -Wall -I include/ src/bytes.c -g
obj/funciones.o: src/funciones.c
	gcc -c -Wall -I include/ src/funciones.c -g
test/fecha:
	./punteros -p 1
